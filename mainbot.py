...
while True:
    user = api.get_user('PunithHonnungar')
    api.update_profile(name=f'PUNITH|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : PUNITH|{follower_count(user)} Followers')
